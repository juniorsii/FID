...
// configure
$from = 'NOVA INSCRICAO VESTIBULAR <nti@deltafaculdade.edu.br>';
$sendTo = 'nti@deltafaculdade.edu.br';
$subject = 'Nova mensagem de Inscrição Vestibular';
...
$okMessage = 'Formulário de contato enviado com sucesso. Obrigado, entraremos em contato com você em breve!';
...
if($responseData->success):
    ...
    try
    {
        $emailText = nl2br("Você tem uma nova inscrição para o Vestibular\n");
