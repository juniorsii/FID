...
// configure
$from = 'NOVA INSCRICAO YOUTUBE <pos@deltafaculdade.edu.br>';
$sendTo = 'historia@deltafaculdade.edu.br';
$subject = 'Nova mensagem de Pré-Inscrição YOUTUBE';
$fields = array('nome' => 'Nome', 'sobrenome' => 'Sobrenome', 'email' => 'Email', 'celular' => 'Celular');
