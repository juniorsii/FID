...
// configure
$from = 'NTI <nti@deltafaculdade.edu.br>';
$sendTo = 'nti@deltafaculdade.edu.br';
$subject = 'Nova mensagem de Relate um erro';
$fields = array('name' => 'Nome', 'email' => 'Email', 'erro' => 'Campo de Erro', 'message' => 'Mensagem');
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    if($responseData->success):
        ...
        try
        {
            ...
            $email_conteudo = "Campo de Erro = $erro \n";
